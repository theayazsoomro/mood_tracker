  ...
  void _drawBrows(
    ...
    switch (mood) {
      case MoodType.happy:
        _drawCurve(
          canvas,
          Offset(center.dx - offsetX - browWidth / 2, browTop),
          Offset(center.dx - offsetX + browWidth / 2, browTop),
          -0.1,
          paint,
        );
      ...
      case MoodType.sad:
        canvas.drawLine(
          Offset(center.dx - offsetX - browWidth / 2, browTop + browHeight),
          Offset(center.dx - offsetX + browWidth / 2, browTop),
          paint,
        );
        canvas.drawLine(
      ...
      case MoodType.frustrated:
        canvas.drawLine(
          Offset(
            center.dx - offsetX - browWidth / 2,
            browTop - browHeight * 0.5,
          ),
          Offset(
            center.dx - offsetX + browWidth / 2,
            browTop + browHeight * 0.5,
